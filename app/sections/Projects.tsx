  ...
  return (
    <section id="projects" className="min-h-screen py-16">
      ...
      <AnimatedContent
          ...
          threshold={0.2}
        >
          <h2 className="text-4xl font-bold text-[#FAFAFA] font-mono mb-8 text-center">Projects</h2>
          ...
          {projects.map((project, index) => (
            <FadeContent key={index} duration={800} delay={index * 200} easing="ease-out" initialOpacity={0}>
              <div className="bg-[#222222] rounded-lg overflow-hidden border border-[#333] hover:border-[#C7EA46] transition-all duration-300 hover:transform hover:scale-[1.02]">
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-[#FAFAFA] font-mono mb-2">{project.title}</h3>
                  <p className="text-[#AAAAAA] font-mono mb-4">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.map((tech, techIndex) => (
                      <span key={techIndex} className="px-3 py-1 bg-[#222222] text-[#C7EA46] rounded-full text-sm font-mono">
                        {tech}
                      </span>
                    ))}
                  </div>
                  <div className="flex gap-4">
                    <div className="relative group w-fit">
                      ...
                      >
                        <span className="relative z-10 flex items-center gap-3">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 group-hover:text-[#1E3A5F] transition-colors duration-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="relative group w-fit">
                      ...
                      >
                        <span className="relative z-10 flex items-center gap-3">
                          <FaGithub className="text-xl group-hover:text-[#1E3A5F] transition-colors duration-500" />
